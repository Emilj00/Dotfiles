...
in
{
  home.file.".config/hypr/autostart.conf".source = "${hyprDir}/${hostname}-autostart.conf";
  ...
  home.file.".config/hypr/workspaces.conf".source = "${hyprDir}/${hostname}-workspaces.conf";
  home.file.".config/hypr/hardware.conf".source = "${hyprDir}/${hostname}-hardware.conf";
